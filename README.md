...
| argo-cd | 9.5.1 | A Helm chart for Argo CD, a declarative, GitOps continuous delivery tool |
...
| argo-workflows | 1.0.10 | A Helm chart for Argo Workflows |
...
| gitlab | 9.11.0 | GitLab is the most comprehensive AI-powered DevSecOps Platform. |
| grafana | 12.1.0 | The leading tool for querying and visualizing time series and metrics. |
...
| kube-prometheus-stack | 83.5.1 | kube-prometheus-stack collects Kubernetes manifests, Grafana dashboards, |
...
| nexus-repository-manager | 88.5.0 | Nexus Repository Manager 3 Single‑Instance Helm Chart |
