...
| argo-cd | 9.4.4 | A Helm chart for Argo CD, a declarative, GitOps continuous delivery tool |
...
| gitlab | 9.9.0 | GitLab is the most comprehensive AI-powered DevSecOps Platform. |
...
| jenkins | 5.8.142 | 'Jenkins - Build great things at any scale! As the leading open source |
...
| kube-prometheus-stack | 82.2.1 | kube-prometheus-stack collects Kubernetes manifests, Grafana dashboards, |
...
| ollama | 1.45.0 | Get up and running with large language models locally. |
...
| rook-ceph-cluster | v1.19.1 | Manages a single Ceph cluster namespace for Rook |
| rook-ceph | v1.19.1 | File, Block, and Object Storage Services for your Cloud-Native Environment |
