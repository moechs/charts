...
| argo-cd | 10.1.3 | A Helm chart for Argo CD, a declarative, GitOps continuous delivery tool |
...
| jenkins | 5.9.34 | 'Jenkins - Build great things at any scale! As the leading open source |
...
| kube-prometheus-stack | 87.16.1 | kube-prometheus-stack collects Kubernetes manifests, Grafana dashboards, |
...
| nexus-repository-manager | 88.8.0 | Nexus Repository Manager 3 Single‑Instance Helm Chart |
...
| ollama | 1.66.0 | Get up and running with large language models locally. |
...
| rustfs | 0.9.0 | RustFS helm chart to deploy RustFS on kubernetes cluster. |
